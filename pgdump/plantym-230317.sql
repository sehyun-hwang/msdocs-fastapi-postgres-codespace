...
--
-- Name: deploy_meta; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.deploy_meta (
    id integer NOT NULL,
    page_info jsonb,
    articles jsonb,
...
ALTER SEQUENCE public.deploy_id_seq OWNED BY public.deploy_meta.id;
...
--
-- Name: COLUMN newspaper_upload.publish_date; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.newspaper_upload.publish_date IS '발행일';


--
-- Name: COLUMN newspaper_upload.is_complete_inspection; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.newspaper_upload.is_complete_inspection IS '검수 완료 여부';


--
-- Name: COLUMN newspaper_upload.created_at; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.newspaper_upload.created_at IS '업로드일';


--
-- Name: COLUMN newspaper_upload.id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.newspaper_upload.id IS '신문지 아이디';


--
-- Name: COLUMN newspaper_upload.newspaper_company_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.newspaper_upload.newspaper_company_id IS '신문사 아이디';


--
-- Name: COLUMN newspaper_upload.inspection_page; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.newspaper_upload.inspection_page IS '검수된 페이지 수';


--
-- Name: COLUMN newspaper_upload.total_page; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.newspaper_upload.total_page IS '총 페이지 수';


--
-- Name: COLUMN newspaper_upload.last_modified_at; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.newspaper_upload.last_modified_at IS '최종 수정일';
...
ALTER SEQUENCE public.newspaper_id_seq OWNED BY public.newspaper_upload.id;
...
CREATE TABLE public.task (
    ...
    CONSTRAINT task_layouts_spaced_pdf_check CHECK ((jsonb_typeof(layouts_spaced_pdf) = 'array'::text))
);
...
--
-- Name: deploy_meta id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.deploy_meta ALTER COLUMN id SET DEFAULT nextval('public.deploy_id_seq'::regclass);
...
--
-- Name: newspaper_upload id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.newspaper_upload ALTER COLUMN id SET DEFAULT nextval('public.newspaper_id_seq'::regclass);


--
-- Name: article_ai article_ai_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.article_ai
    ADD CONSTRAINT article_ai_pkey PRIMARY KEY (id);


--
-- Name: deploy_meta deploy_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.deploy_meta
...
--
-- Name: newspaper_upload newspaper_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: newspaper_upload unique_author_date; Type: CONSTRAINT; Schema: public; Owner: -
--
...
CREATE INDEX daily_newspaper_created_at_idx ON public.newspaper_upload USING btree (created_at);
...
--
-- Name: newspaper_upload daily_newspaper_author_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
ALTER TABLE ONLY public.pdf
    ADD CONSTRAINT pdf_daily_newspaper_id_fkey FOREIGN KEY (daily_newspaper_id) REFERENCES public.newspaper_upload(id) ON DELETE CASCADE;
